...
import planning_model_build_v1 as v1
...
model1_byproduct = helper.train_model(unit_1_train, ["Raw1"], ["ByProduct"], "byproduct", save_model=False)
...
model1_product = helper.train_model(clean_unit1, ["Raw1"], ["Product1"], "product_1", save_model=True)
model1_byproduct = helper.train_model(clean_unit1, ["Raw1"], ["ByProduct"], "byproduct", save_model=True)
model2_product = helper.train_model(clean_unit2, ["ByProduct_From_1_to_2", "Raw2"], ["Product2"], "product_2", model_type="Non-Linear", save_model=True)
model3_product = helper.train_model(clean_unit3, ["ByProduct_From_1_to_3", "Raw3_1", "Raw3_2"], ["Product3"], "product_3", model_type="Non-Linear", save_model=True)
