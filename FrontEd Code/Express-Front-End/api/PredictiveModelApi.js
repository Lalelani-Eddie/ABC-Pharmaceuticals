const PredictiveModelAPI = {
    ...
    getHeaders() {
        return [
            "scenario", "raw1", "raw2", "raw3_1", "raw3_2", "weightByproductToUnit2", "weightByproductToUnit3",
            "product1Production", "product2Production", "product3Production", "byproductProduction",
            "totalRevenue", "product1Revenue", "product1OverProductionCost", "product1UnderProductionCost",
            "product2Revenue", "product2OverProductionCost", "product2UnderProductionCost",
            "product3Revenue", "product3OverProductionCost", "product3UnderProductionCost",
            "excessByproductCost"
        ];
    }
}

module.exports = PredictiveModelAPI;